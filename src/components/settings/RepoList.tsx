        ...
        <div key={repo.id} className={styles.repoCard}>
          <div className={styles.repoTop}>
            <div className={styles.repoInfo}>
              ...
              <div>
                <div className={styles.repoName}>
                  <Link href={`/settings/repository/${repo.id}`} className={styles.repoLink}>
                    {repo.fullName}
                  </Link>
                  <a href={repo.htmlUrl} target="_blank" rel="noopener noreferrer" className={styles.githubLink} title="View on GitHub">
                    <ExternalIcon />
                  </a>
            ...
            <div className={styles.repoActions}>
              <Link
                href={`/settings/repository/${repo.id}`}
